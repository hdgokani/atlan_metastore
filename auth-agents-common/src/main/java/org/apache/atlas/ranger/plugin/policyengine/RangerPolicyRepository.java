...
package org.apache.atlas.ranger.plugin.policyengine;
...
import org.apache.atlas.ranger.plugin.contextenricher.RangerAbstractContextEnricher;
import org.apache.atlas.ranger.plugin.contextenricher.RangerContextEnricher;
import org.apache.atlas.ranger.plugin.contextenricher.RangerTagEnricher;
import org.apache.atlas.ranger.plugin.contextenricher.RangerTagForEval;
import org.apache.atlas.ranger.plugin.model.AuditFilter;
...
import org.apache.atlas.ranger.plugin.model.RangerPolicyDelta;
import org.apache.atlas.ranger.plugin.model.RangerServiceDef;
import org.apache.atlas.ranger.plugin.model.validation.RangerServiceDefHelper;
import org.apache.atlas.ranger.plugin.policyevaluator.RangerAbstractPolicyEvaluator;
import org.apache.atlas.ranger.plugin.policyevaluator.RangerAuditPolicyEvaluator;
import org.apache.atlas.ranger.plugin.policyevaluator.RangerCachedPolicyEvaluator;
import org.apache.atlas.ranger.plugin.policyevaluator.RangerOptimizedPolicyEvaluator;
import org.apache.atlas.ranger.plugin.policyevaluator.RangerPolicyEvaluator;
import org.apache.atlas.ranger.plugin.store.AbstractServiceStore;
import org.apache.atlas.ranger.plugin.util.RangerPerfTracer;
import org.apache.atlas.ranger.plugin.util.ServiceDefUtil;
...
import static org.apache.atlas.ranger.plugin.contextenricher.RangerTagEnricher.TAG_RETRIEVER_CLASSNAME_OPTION;
import static org.apache.atlas.ranger.plugin.policyengine.RangerPolicyEngine.PLUGIN_AUDIT_FILTER;
...
public class RangerPolicyRepository {
    ...
    List<RangerPolicyEvaluator> getPolicyEvaluators(String policyType) {
        switch (policyType) {
    ...
    List<PolicyEvaluatorForTag> getLikelyMatchPolicyEvaluators(RangerAccessRequest request, Set<RangerTagForEval> tags, String policyType, Date accessTime) {
    ...
    public List<RangerPolicyEvaluator> getLikelyMatchPolicyEvaluators(RangerAccessRequest request, String policyType) {
        switch (policyType) {
            case RangerPolicy.POLICY_TYPE_ACCESS:
            ...
            for (RangerServiceDef.RangerContextEnricherDef enricherDef : serviceDef.getContextEnrichers()) {
                ...
                if (!options.disableContextEnrichers || options.enableTagEnricherWithLocalRefresher && StringUtils.equals(enricherDef.getEnricher(), RangerTagEnricher.class.getName())) {
                    ...
                    if (options.enableTagEnricherWithLocalRefresher && StringUtils.equals(enricherDef.getEnricher(), RangerTagEnricher.class.getName())) {
                        contextEnricherDef = new RangerServiceDef.RangerContextEnricherDef(enricherDef.getItemId(), enricherDef.getName(), "org.apache.atlas.ranger.common.RangerAdminTagEnricher", null);
                    }
    ...
    private void deletePolicyEvaluator(RangerPolicyEvaluator evaluator) {
        ...
        String policyType = evaluator.getPolicy().getPolicyType();
    ...
    Map<String, RangerResourceTrie> getTrie(final String policyType) {
        final Map<String, RangerResourceTrie> ret;
        switch (policyType) {
            case RangerPolicy.POLICY_TYPE_ACCESS:
    ...
    private void updateResourceTrie(List<RangerPolicyDelta> deltas) {
        ...
        for (RangerPolicyDelta delta : deltas) {
            ...
            if (evaluator != null) {
                ...
                flags.add(policyType);
            }
        }

        for (String policyType : flags) {
