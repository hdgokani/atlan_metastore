...
package org.apache.atlas.ranger.plugin.policyresourcematcher;
...
import org.apache.atlas.ranger.plugin.resourcematcher.RangerDefaultResourceMatcher;
...
public class RangerDefaultPolicyResourceMatcher implements RangerPolicyResourceMatcher {
    ...
    public void init() {
        ...
        if (allMatchers == null && !RangerPolicy.POLICY_TYPE_AUDIT.equals(policyType)) {
