...
public class RangerCustomConditionEvaluator {
    ...
    private RangerConditionEvaluator newConditionEvaluator(String className) {
        ...
        try {
            ...
            Class<org.apache.atlas.ranger.plugin.conditionevaluator.RangerConditionEvaluator> matcherClass = (Class<org.apache.atlas.ranger.plugin.conditionevaluator.RangerConditionEvaluator>)Class.forName(className);
