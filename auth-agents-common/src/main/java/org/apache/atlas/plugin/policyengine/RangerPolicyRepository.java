...
import org.apache.atlas.plugin.policyevaluator.RangerAbstractPolicyEvaluator;
...
import static org.apache.atlas.plugin.contextenricher.RangerTagEnricher.TAG_RETRIEVER_CLASSNAME_OPTION;
import static org.apache.atlas.plugin.policyengine.RangerPolicyEngine.PLUGIN_AUDIT_FILTER;
            ...
            for (RangerServiceDef.RangerContextEnricherDef enricherDef : serviceDef.getContextEnrichers()) {
                ...
                if (!options.disableContextEnrichers || options.enableTagEnricherWithLocalRefresher && StringUtils.equals(enricherDef.getEnricher(), RangerTagEnricher.class.getName())) {
                    ...
                    if (options.enableTagEnricherWithLocalRefresher && StringUtils.equals(enricherDef.getEnricher(), RangerTagEnricher.class.getName())) {
                        contextEnricherDef = new RangerServiceDef.RangerContextEnricherDef(enricherDef.getItemId(), enricherDef.getName(), "org.apache.atlas.common.RangerAdminTagEnricher", null);
                    }
