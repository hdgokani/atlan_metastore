...
public class TaskManagement implements Service, ActiveStateChangeHandler {
    ...
    public AtlasTask createTask(String taskType, String createdBy, Map<String, Object> parameters, String uniqueParameter, String referenceId) {
        return this.registry.createVertex(taskType, createdBy, parameters, uniqueParameter, referenceId);
    }
