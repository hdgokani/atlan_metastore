...
//                                                                                        relationship.getTypeName(), end1Entity, end2Entity));
            AtlasAuthorization.verifyAccess(AtlasPrivilege.RELATIONSHIP_ADD.getType(), end1Entity.getGuid(), end2Entity.getGuid());
...
//        AtlasAuthorizationUtils.verifyAccess(new AtlasRelationshipAccessRequest(typeRegistry, AtlasPrivilege.RELATIONSHIP_UPDATE, relationship.getTypeName(), end1Entity, end2Entity));
        AtlasAuthorization.verifyAccess(AtlasPrivilege.RELATIONSHIP_UPDATE.getType(), end1Entity.getGuid(), end2Entity.getGuid());
