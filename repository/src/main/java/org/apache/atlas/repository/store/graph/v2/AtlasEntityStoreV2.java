    ...
    public List<PreProcessor> getPreProcessor(String typeName) {
        ...
        switch (typeName) {
            case ATLAS_GLOSSARY_ENTITY_TYPE:
                preProcessors.addFirst(new GlossaryPreProcessor(typeRegistry, entityRetriever, graph));
                break;
            ...
            case DATA_DOMAIN_ENTITY_TYPE:
                preProcessors.addFirst(new DataDomainPreProcessor(typeRegistry, entityRetriever, graph, this));
                break;
