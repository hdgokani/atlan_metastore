...
public class EntityREST {
        ...
        try {
            ...
            for (int i = 0; i < entities.size(); i++) {
                ...
                if (ENTITY_READ.name().equals(action) || ENTITY_CREATE.name().equals(action) || ENTITY_UPDATE.name().equals(action)
                    ...
                    try {
                        AtlasPerfMetrics.MetricRecorder evaluatePoliciesMetric11 = RequestContext.get().startMetricRecord("evaluatePolicies11");
                        ...
                        RequestContext.get().endMetricRecord(evaluatePoliciesMetric11);
                    } catch (AtlasBaseException e) {
                        AtlasPerfMetrics.MetricRecorder evaluatePoliciesMetric12 = RequestContext.get().startMetricRecord("evaluatePolicies12");
                        ...
                        RequestContext.get().endMetricRecord(evaluatePoliciesMetric12);
                    }
                    ...
                    try {
                        AtlasPerfMetrics.MetricRecorder evaluatePoliciesMetric21 = RequestContext.get().startMetricRecord("evaluatePolicies21");
                        AtlasEntityHeader entityHeader = getAtlasEntityHeader(entities.get(i).getEntityGuid(), entities.get(i).getEntityId(),entities.get(i).getTypeName());
                        ...
                        RequestContext.get().endMetricRecord(evaluatePoliciesMetric21);
                    } catch (AtlasBaseException e) {
                        AtlasPerfMetrics.MetricRecorder evaluatePoliciesMetric22 = RequestContext.get().startMetricRecord("evaluatePolicies22");
                        AtlasErrorCode code = e.getAtlasErrorCode();
                        String errorCode = code.getErrorCode();
                        ...
                        RequestContext.get().endMetricRecord(evaluatePoliciesMetric22);
                    }
                    ...
                    try {
                        AtlasPerfMetrics.MetricRecorder evaluatePoliciesMetric31 = RequestContext.get().startMetricRecord("evaluatePolicies31");
                        ...
                        RequestContext.get().endMetricRecord(evaluatePoliciesMetric31);
                    } catch (AtlasBaseException e) {
                        AtlasPerfMetrics.MetricRecorder evaluatePoliciesMetric32 = RequestContext.get().startMetricRecord("evaluatePolicies32");
                        AtlasErrorCode code = e.getAtlasErrorCode();
                        String errorCode = code.getErrorCode();
                        ...
                        RequestContext.get().endMetricRecord(evaluatePoliciesMetric32);
                    }
                }
    ...
    private AtlasEntityHeader getAtlasEntityHeader(String entityGuid, String entityId, String entityType) throws AtlasBaseException {
        AtlasPerfMetrics.MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("getAtlasEntityHeader");
